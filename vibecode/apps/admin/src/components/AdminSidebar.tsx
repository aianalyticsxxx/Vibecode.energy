...
const navItems = [
  ...
  { href: '/content', label: 'Content', icon: GridIcon },
...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-admin-bg-elevated border-r border-admin-border flex flex-col h-screen sticky top-0">
      {/* Logo */}
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'text-admin-text-secondary hover:bg-admin-bg-hover hover:text-admin-text'
              )}
            >
      ...
      <div className="p-4 border-t border-admin-border">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-admin-text-dim truncate">
              @{user?.username || 'admin'}
            </p>
          </div>
        </div>
        <button
          onClick={logout}
          className="w-full px-3 py-2 text-sm font-medium text-admin-text-secondary hover:text-admin-error hover:bg-admin-bg-hover rounded-lg transition-colors"
        >
          Sign Out
        </button>
      </div>
