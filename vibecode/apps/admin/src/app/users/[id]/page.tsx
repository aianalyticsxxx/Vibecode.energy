...
import { adminApi, type AdminShot, type AdminReport } from '@/lib/api';
    ...
    return (
      <AdminLayout>
        <div className="text-center py-12">
          ...
          <Button variant="secondary" className="mt-4" onClick={() => router.push('/users')}>
            Back to Users
          </Button>
        </div>
      </AdminLayout>
      ...
      <div className="space-y-6">
        ...
        {activeTab === 'reports' && (
          <DataTable
            ...
            onRowClick={(report) => router.push(`/moderation?report=${report.id}`)}
          />
        )}
